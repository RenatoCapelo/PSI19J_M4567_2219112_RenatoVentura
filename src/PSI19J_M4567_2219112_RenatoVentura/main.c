...
int main()
{
    ...
    if(exists("Python\\dist\\mailsender.exe")==0)
    {
        ...
        puts("\n\n                                                         WARNING!\n\n\n");
        puts("                          O Programa não pode iniciar com sucesso, pois faltam ficheiros requeridos.\n");
        puts("                          Por favor tente instalar novamente com o seu antivirus desligado,\n");
        puts("                          ou abra uma exceção à pasta de instalação do programa no seu antivirus\n\n");
